...
// 测试用的HTML页文件夹地址和文件名称
var src = '/Users/huanghui/Documents/workspace/Demo/nodejs/test/common', filename = 'test.html';
var targetSrc = '/Users/huanghui/Documents/workspace/Demo/nodejs/test/';
var fnImportExample = function(src, filename) {
    ...
    fs.readFile(src + '/' + filename, {
        ...
        fs.writeFile(targetSrc+'/'+filename, dataReplace, {
            encoding: 'utf8'
        }, function(err) {
            if (err) throw err;
